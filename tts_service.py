...
class WhisperSpeechTTS:
    ...
    def initialize_model(self):
        self.pipe = Pipeline(t2s_ref='collabora/whisperspeech:t2s-v1.95-medium-7lang.model', s2a_ref='collabora/whisperspeech:s2a-v1.9-base-7lang.model', torch_compile=True, device="cuda:1")
