...
def parse_arguments():
    ...
    # LLM arguments are no longer needed
...
if __name__ == "__main__":
    ...
    # LLM-related checks are no longer needed
    # if args.mistral:
    ...
    # Only join processes that were started
    whisper_process.join()
    # llm_process.join()  # Not needed since LLM process is skipped
    tts_process.join()
